---
name: doc-sync
description: Synchronizes AGENTS.md navigation indexes and README.md architecture docs across a repository. Use when asked to "sync docs", "update AGENTS.md files", "ensure documentation is in sync", "audit documentation", or when documentation maintenance is needed after code changes.
---

# Doc Sync

Maintains the AGENTS.md navigation hierarchy and optional README.md architecture docs across a repository. This skill is self-contained and performs all documentation work directly.
...
### ROOT vs SUBDIRECTORY AGENTS.md
...
**Critical constraint:** Subdirectory AGENTS.md files are PURE INDEX. No prose, no overview sections, no architectural explanations. Those belong in README.md.
...
- You'd be restating what AGENTS.md index entries already convey
...
- Overview sections with prose (in subdirectory AGENTS.md files)
...
2. All AGENTS.md files use table-based index format
3. No drift remains (files <-> index entries match)
4. No misplaced content in AGENTS.md (architecture docs moved to README.md)
5. README.md files are indexed in their parent AGENTS.md
6. Subdirectory AGENTS.md files contain no prose/overview sections
